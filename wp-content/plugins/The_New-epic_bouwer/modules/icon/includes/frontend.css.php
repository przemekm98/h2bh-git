...
if($settings->three_d) {
	...
	$border_color = EPBOUWERColor::adjust_brightness($settings->bg_color, 20, 'darken');
}
if($settings->three_d && !empty($settings->bg_hover_color)) {
	...
	$border_hover_color = EPBOUWERColor::adjust_brightness($settings->bg_hover_color, 20, 'darken');
}
