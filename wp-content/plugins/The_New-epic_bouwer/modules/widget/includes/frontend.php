...
else if(isset($post_data['widget']) && EPBOUWERModel::is_builder_active()) {
...
else if(isset($widget_slug) && EPBOUWERModel::is_builder_active()) {

	// Widget doesn't exist!
	printf( _x( '%s no longer exists.', '%s stands for widget slug.', 'ep-bouwer' ), $widget_slug );
