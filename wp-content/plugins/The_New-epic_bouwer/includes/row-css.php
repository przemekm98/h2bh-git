...
.fl-node-<?php echo $row->node; ?> .fl-row-content-wrap {
	...
	background-color: rgba(<?php echo implode(',', EPBOUWERColor::hex_to_rgb($row->settings->bg_color)) ?>, <?php echo $row->settings->bg_opacity/100; ?>);
}
<?php endif; ?>
...
.fl-node-<?php echo $row->node; ?> .fl-row-content-wrap:after {
	...
	background-color: rgba(<?php echo implode(',', EPBOUWERColor::hex_to_rgb($row->settings->bg_overlay_color)) ?>, <?php echo $row->settings->bg_overlay_opacity/100; ?>);
}
<?php endif; ?>
...
.ep-bouwer-touch .fl-node-<?php echo $row->node; ?> .fl-row-content-wrap {
...
.fl-node-<?php echo $row->node; ?> .fl-row-content-wrap {
	...
	border-color: rgba(<?php echo implode(',', EPBOUWERColor::hex_to_rgb($row->settings->border_color)) ?>, <?php echo $row->settings->border_opacity/100; ?>);
