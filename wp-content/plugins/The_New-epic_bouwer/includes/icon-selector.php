<div class="fl-lightbox-header">
	<h1><?php _e( 'Select Icon', 'ep-bouwer' ); ?></h1>
	<div class="fl-icons-filter ep-bouwer-settings-fields">
		<select class="fl-icons-filter-select">
			<option value="all"><?php _ex( 'All Libraries', 'Select option for showing all icon libraries.', 'ep-bouwer' ); ?></option>
...
<div class="fl-lightbox-footer fl-icon-selector-footer">
	<a class="fl-icon-selector-cancel ep-bouwer-button ep-bouwer-button-large" href="javascript:void(0);" onclick="return false;"><?php _e('Cancel', 'ep-bouwer'); ?></a>
</div>