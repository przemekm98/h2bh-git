...
class EPBOUWERModule {
	...
	public function __construct($params)
	{
		...
		if(is_child_theme() && stristr($dir_path, $stylesheet_directory)) {
			...
			$this->url = isset($params['url']) ? $params['url'] : EP_BOUWER_URL . 'modules/' . $this->slug . '/';
			$this->dir = isset($params['dir']) ? $params['dir'] : EP_BOUWER_DIR . 'modules/' . $this->slug . '/';
		}
	}
	...
	{
		EPBOUWERIcons::enqueue_styles_for_module( $this );
	}
