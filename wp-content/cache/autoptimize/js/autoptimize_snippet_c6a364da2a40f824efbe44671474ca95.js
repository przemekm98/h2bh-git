...
else if(this.settings.layout=='gallery'){this.gallery.resize();elements.css('visibility','visible');}}};})(jQuery);(function($){$(function(){new EPBOUWERPostGrid({id:'59fb29d12f218',layout:'grid',pagination:'numbers',postSpacing:'30',postWidth:'300'});});$(window).on('load',function(){$('.fl-node-59fb29d12f218 .fl-post-grid').masonry('reloadItems');});})(jQuery);var wpAjaxUrl='https://how2behealthy.nl/wp-admin/admin-ajax.php';var flBuilderUrl='https://how2behealthy.nl/wp-content/plugins/The_New-epic_bouwer/';