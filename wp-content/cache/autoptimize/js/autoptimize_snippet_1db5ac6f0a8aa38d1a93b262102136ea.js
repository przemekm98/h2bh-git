...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){EPBOUWERLayout.init();});})(jQuery);var EPBOUWERPostGrid;(function($){EPBOUWERPostGrid=function(settings)
...
else if(this.settings.layout=='gallery'){this.gallery.resize();elements.css('visibility','visible');}}};})(jQuery);(function($){$(function(){new EPBOUWERPostGrid({id:'59f99b743a0f9',layout:'grid',pagination:'numbers',postSpacing:'30',postWidth:'300'});});$(window).on('load',function(){$('.fl-node-59f99b743a0f9 .fl-post-grid').masonry('reloadItems');});})(jQuery);(function($){$(function(){var slider=$('.fl-node-59f5b02875d7c .fl-content-slider').bxSlider({adaptiveHeight:true,auto:false,autoHover:true,autoControls:false,pause:10000,mode:'horizontal',speed:500,controls:false,pager:false,video:true,onSliderLoad:function(){$('.fl-node-59f5b02875d7c .fl-content-slider').addClass('fl-content-slider-loaded');}});slider.data('bxSlider',slider);});})(jQuery);var wpAjaxUrl='https://how2behealthy.nl/wp-admin/admin-ajax.php';var flBuilderUrl='https://how2behealthy.nl/wp-content/plugins/The_New-epic_bouwer/';