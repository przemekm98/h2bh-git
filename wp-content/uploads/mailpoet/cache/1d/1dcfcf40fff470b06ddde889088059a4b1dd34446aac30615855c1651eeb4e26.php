...
class __TwigTemplate_ba3d1bf9171e1f03dbf567c781c7a259d8b81107676046152b572d6a052c28a0 extends Twig_Template
{
  ...
  <select name=\"params[date_type]\">
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["date_types"]) ? $context["date_types"] : null));
        ...
        data-format=\"";
            // line 9
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["date_formats"]) ? $context["date_formats"] : null), $context["type"], array(), "array"), 0, array(), "array"), "html", null, true);
            echo "\" value=\"";
            echo twig_escape_filter($this->env, $context["type"], "html", null, true);
            echo "\"
      >";
...
<{{!}}/script>";
    ...
    {
        return new Twig_Source("", "form/templates/settings/date_types.hbs", "/var/www/vhosts/how2behealthy.nl/httpdocs/wp-content/plugins/mailpoet/views/form/templates/settings/date_types.hbs");
    }
}
