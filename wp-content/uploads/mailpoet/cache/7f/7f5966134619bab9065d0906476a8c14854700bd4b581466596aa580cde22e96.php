...
class __TwigTemplate_65c72b87ea470041dc23c25095e5af4fed222e7ff5294c330dd137c5c8a6fcf9 extends Twig_Template
{
...
";
    ...
    public function block_translations($context, array $blocks = array())
    {
        // line 324
        echo "  ";
        $context["helpTooltipSendPreview"] = twig_escape_filter($this->env, MailPoet\Util\Helpers::replaceLinkTags($this->env->getExtension('MailPoet\Twig\I18n')->translate("Didn't receive the test email? Read our [link]quick guide[/link] to sending issues. <br><br>A MailPoet logo will appear in the footer of all emails sent with the free version of MailPoet. <br><br>Links in footer don't work in email previews!"), "http://beta.docs.mailpoet.com/article/146-my-newsletters-are-not-being-received", array("target" => "_blank")), "js");
        // line 327
        echo "  ";
