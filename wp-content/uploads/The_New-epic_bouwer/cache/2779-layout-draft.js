...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){EPBOUWERLayout.init();});})(jQuery);(function($){$(function(){var slider=$('.fl-node-5655eddf40e1b .fl-content-slider').bxSlider({adaptiveHeight:true,auto:true,autoHover:true,autoControls:false,pause:10000,mode:'horizontal',speed:500,controls:true,pager:false,video:true,onSliderLoad:function(){$('.fl-node-5655eddf40e1b .fl-content-slider').addClass('fl-content-slider-loaded');}});slider.data('bxSlider',slider);});})(jQuery);var EPBOUWERPostGrid;(function($){EPBOUWERPostGrid=function(settings)
