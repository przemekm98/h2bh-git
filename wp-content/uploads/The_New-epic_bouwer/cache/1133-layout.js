...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){EPBOUWERLayout.init();});})(jQuery);(function($){$('.fl-node-56686a665dff4 .fl-slider-next').empty();$('.fl-node-56686a665dff4 .fl-slider-prev').empty();$('.fl-node-56686a665dff4 .fl-testimonials').bxSlider({autoStart:1,auto:true,adaptiveHeight:true,pause:40000,mode:'horizontal',speed:500,pager:0,nextSelector:'.fl-node-56686a665dff4 .fl-slider-next',prevSelector:'.fl-node-56686a665dff4 .fl-slider-prev',nextText:'<i class="fa fa-chevron-circle-right"></i>',prevText:'<i class="fa fa-chevron-circle-left"></i>',controls:1,onSliderLoad:function(){$('.fl-node-56686a665dff4 .fl-testimonials').addClass('fl-testimonials-loaded');}});})(jQuery);var wpAjaxUrl='https://how2behealthy.nl/wp-admin/admin-ajax.php';var flBuilderUrl='https://how2behealthy.nl/wp-content/plugins/The_New-epic_bouwer/';