...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){EPBOUWERLayout.init();});})(jQuery);(function($){$(function(){var slider=$('.fl-node-5a8434ee7980f .fl-content-slider').bxSlider({adaptiveHeight:true,auto:true,autoHover:true,autoControls:false,pause:5000,mode:'horizontal',speed:500,controls:false,pager:false,video:true,onSliderLoad:function(){$('.fl-node-5a8434ee7980f .fl-content-slider').addClass('fl-content-slider-loaded');}});slider.data('bxSlider',slider);});})(jQuery);var wpAjaxUrl='https://how2behealthy.nl/wp-admin/admin-ajax.php';var flBuilderUrl='https://how2behealthy.nl/wp-content/plugins/The_New-epic_bouwer/';