...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){EPBOUWERLayout.init();});})(jQuery);(function($){$(function(){var slider=$('.fl-node-588e3eb40b993 .fl-content-slider').bxSlider({adaptiveHeight:true,auto:false,autoHover:true,autoControls:false,pause:5000,mode:'horizontal',speed:500,controls:false,pager:false,video:true,onSliderLoad:function(){$('.fl-node-588e3eb40b993 .fl-content-slider').addClass('fl-content-slider-loaded');}});slider.data('bxSlider',slider);});})(jQuery);var EPBOUWERPostGrid;(function($){EPBOUWERPostGrid=function(settings)
...
else if(this.settings.layout=='gallery'){this.gallery.resize();elements.css('visibility','visible');}}};})(jQuery);(function($){$(function(){new EPBOUWERPostGrid({id:'588e4043b55a5',layout:'grid',pagination:'numbers',postSpacing:'60',postWidth:'300'});});$(window).on('load',function(){$('.fl-node-588e4043b55a5 .fl-post-grid').masonry('reloadItems');});})(jQuery);(function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(d.getElementById(id))return;js=d.createElement(s);js.id=id;js.src="//connect.facebook.net/en_US/all.js#xfbml=1&appId=525994720806655";fjs.parentNode.insertBefore(js,fjs);}(document,'script','facebook-jssdk'));var wpAjaxUrl='https://how2behealthy.nl/wp-admin/admin-ajax.php';var flBuilderUrl='https://how2behealthy.nl/wp-content/plugins/The_New-epic_bouwer/';